...
import { IChartProps } from "../../types/IDataPointScatter";
...
export interface IScatterPlotProps {
  ...
  /**
   * Additional CSS class(es) to apply to the ScatterPlot.
   */
  className?: string;
   ...
   */
  styles?: IStyleFunctionOrObject<IScatterPlotStyleProps, IScatterPlotStyles>;
...
export interface IScatterPlotStyleProps {
  theme: ITheme;
  className?: string;
  width: number;
  height: number;
...
export interface IScatterPlotStyles {
  /**
